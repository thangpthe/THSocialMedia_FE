...
// import { RelationshipApi, Auth } from '../lib/api';
...
//   // Hàm kiểm tra trạng thái quan hệ để hiển thị nút bấm chính xác
...
//     if (request) {
//       // Nếu mình là người nhận (friendId là myId)
...
//   useEffect(() => {
//     if (tab === 'all' || tab === 'requests' || tab === 'search') {
//       loadRelationships();
//     }
...
//     setLoading(true);
//     try {
//       // Gọi API search cùng lúc với cập nhật quan hệ để dữ liệu luôn mới nhất
...
//       await loadRelationships(); // Cập nhật lại trạng thái ngay lập tức
//     } catch (err) {
...
//         {/* ── Search Bar (Chỉ hiện ở Tab Tìm kiếm) ── */}
//         {tab === 'search' && (
//           <div className="f-search">
//             <span className="material-symbols-outlined f-search-icon">search</span>
//             <input
//               type="text"
//               placeholder="Nhập username chính xác để tìm..."
//               value={searchQuery}
...
//                     <div className="f-avatar">{getInitials(r.userName || r.senderName)}</div>
...
//                   return (
//                     <div key={r.id} className="f-card">
//                       <div className="f-avatar">{getInitials(name)}</div>
//                       <div className="f-info">
